...
from pygments.formatters.latexlisting import LatexListingFormatter
...
FORMATTERS = {
    ...
    LatexListingFormatter: ('LaTeX Listing', ('latexlisting', 'texlisting'), ('*.tex',), 'Format tokens as LaTeX code. This needs the `listings` and `color` standard packages.'),
