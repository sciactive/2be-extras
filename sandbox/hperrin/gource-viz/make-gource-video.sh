...
gource --title Pines -1280x720 --highlight-colour 22FF55 --hide mouse,filenames --highlight-users --max-user-speed 1000 --user-scale 5 --max-file-lag 0.1 --max-files 0 -i 0 -a 1 -s .5 -c 4 -e 0.01 -o gource-output.ppm -r 60 combined.txt
