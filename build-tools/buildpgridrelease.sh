...
cp "../pines/components/com_pgrid/includes/jquery.pgrid.default.icons.css" "jquery.pgrid/use for pines style icons/"
cp "../pines/components/com_pgrid/includes/jquery.pgrid.default.css" "jquery.pgrid/"
cp "../pines/components/com_pgrid/includes/jquery.pgrid.js" "jquery.pgrid/"
