...
<div class="header"><img style="float:right;" src="?logo=1" alt="2be Logo" />
	<h1>2be Installation</h1><hr /></div>
<p>Please enter the directory where you would like to extract the 2be files. Leave this blank to use the current directory. If the directory does not exist, it will be created for you. It can't be a parent directory. After the files are extracted, you will be redirected to the directory.</p>
...
<p><small>This Slim Self Extractor was developed by Hunter Perrin as part of <a href="http://2be.io/">2be</a>.</small></p>
</div>
</body>
</html>
<?php
